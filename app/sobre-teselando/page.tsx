...
export default function Page() { return <DetailPage eyebrow="SOBRE TESELANDO" title="Una academia online de clases particulares gestionadas" intro="Teselando absorbe complejidad para que el estudiante pueda centrarse en aprender." heroImage="/images/teselando/inside-05.webp" heroImageAlt="Una clase online de Teselando" sections={[
