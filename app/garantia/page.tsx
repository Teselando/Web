...
export default function Page() { return <DetailPage eyebrow="GARANTÍA TESELANDO" title="Para que puedas empezar con tranquilidad" intro="Si surge una incidencia, Teselando sigue detrás para ayudarte a resolverla." sections={[
